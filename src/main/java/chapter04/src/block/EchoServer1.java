    ...
    public void service() {
        while (true) {
            ...
            try {
                ...
                //处理客户连接
                executorService.execute(new Handler1(socketChannel));
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
...
class Handler1 implements Runnable {  //处理客户连接
    private SocketChannel socketChannel;

    public Handler1(SocketChannel socketChannel) {
