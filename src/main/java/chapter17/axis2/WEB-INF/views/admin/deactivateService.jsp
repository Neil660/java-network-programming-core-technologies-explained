...
<form method="post" name="serviceInActivate" action="<c:url value="axis2-admin/doDeactivateService"/>">
    <table summary="main content table" style="width: 100%" border="0">
        <tr>
            <td colspan="2">
                <p>Only the services that are active are listed below. Note that although you can activate a service
                    from this page, once system is restarted the service will be active again</p>
            </td>
        </tr>
        <tr>
            <%
