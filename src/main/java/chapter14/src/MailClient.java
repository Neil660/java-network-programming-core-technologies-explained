...
public class MailClient {
  ...
  public void browseMessagesFromFolder(String folderName)
                                        throws Exception{
  ...
  public void browseMessagesFromFolder(Folder folder)
                                     throws Exception{
    folder.open(Folder.READ_ONLY);
    System.out.println("You have "+folder.getMessageCount()
                                  +" messages in "+folder.getName());
    System.out.println("You have "
+folder.getUnreadMessageCount()+" unread messages in "+folder.getName());
