...
<blockquote>
    <p>Hot deployment of new service archives is <%=request.getAttribute("hotDeployment") %>
    </p>
    <p>Hot update of existing service archives is <%=request.getAttribute("hotUpdate") %>
    </p>
</blockquote>
